...
import { useGetAvarageDistrictFields } from "./hooks.js";
...
const avarageDatasOfGumus = useGetAvarageDistrictFields(analysesData, "гумус, %");
...
for (let [key, value] of Object.entries(avarageDatasOfGumus)) {
  for (let polygon of regionsData) {
    L.geoJSON(polygon, {
      ...
      style: (feature) => disctrictStyle(feature, key, value),
    }).addTo(map);
  }
}
